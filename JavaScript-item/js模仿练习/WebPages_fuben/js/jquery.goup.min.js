...
(function ($) {
    $.fn.goup = function (options) {
        $.fn.goup.defaultOpts = {
            appear: 200,
            scrolltime: 800,
            imgsrc: "http://s25.postimg.org/m4fb58rez/goup.png",
            width: 72,
            place: "bottom-right",
            fadein: 500,
            fadeout: 500,
        ...
        return this.each(function () {
            ...
            goup.css({"position": "fixed", "display": "block", "width": "'" + opts.width + "px'", "z-index": "9"});
            ...
            $(function () {
                $(window).scroll(function () {
                    if ($(this).scrollTop() > opts.appear) goupimg.fadeIn(opts.fadein); else goupimg.fadeOut(opts.fadeout)
                });
                ...
                $(goupa).click(function () {
                    $("body,html").animate({scrollTop: 0}, opts.scrolltime);
                    return false
                })
            });
            if (opts.place === "top-right") goup.css({"top": "2%", "right": "2%"});
                ...
                "bottom": "2%",
                "left": "2%"
            }); else goup.css({"bottom": "2%", "right": "2%"})
        })
    }
})(jQuery);